...
describe('Address', function() {
  ...
  var buf = Buffer.concat([new Buffer([0x89]), pubkeyhash]);
  var str = 'xDoCgAmtyfLH13k9bkuQP2y1awRiz5Y1qR';
  ...
  // livenet valid
  var PKHLivenet = [
    'xDEPWCVawtW5yiGeupQFw5eVwbWqQKo3nu',
    'xHQYmtiz4CK3UcWCiKhZKPyoJ3upkNXAcQ',
    'xK8EiYB6oqHDUXnBU3rC86eU57WdGmQtuM',
    'xSHfs5G6M9w3rQnMBiokP3jBtk4HBEhKZp',
    '    xSHfs5G6M9w3rQnMBiokP3jBtk4HBEhKZp   \t\n'
  ];
  ...
  describe('validation', function() {
    ...
    it('addresses with whitespace are validated correctly', function() {
      ...
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('xHQYmtiz4CK3UcWCiKhZKPyoJ3upkNXAcQ');
    });
  });
  ...
  describe('encodings', function() {
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('xGyuynYJoohMuGrLSa2XzZmLs6krQzFtqp');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('xDcAgaoCaCBziN3wKZujJRuk5oBNAKaA7c');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('xDcAgaoCaCBziN3wKZujJRuk5oBNAKaA7c');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('xScnhru4Wzce4GCD8CKMim6DTPFGnbWZCV');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('xScnhru4Wzce4GCD8CKMim6DTPFGnbWZCV');
      });
      ...
      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'xDcAgaoCaCBziN3wKZujJRuk5oBNAKaA7c';
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: xDoCgAmtyfLH13k9bkuQP2y1awRiz5Y1qR, type: pubkeyhash, network: livenet>';
