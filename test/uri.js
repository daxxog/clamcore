...
describe('URI', function() {
  ...
  it('parses uri strings correctly (test vector)', function() {
    ...
    uri = URI.parse('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7');
    uri.address.should.equal('xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7');
    expect(uri.amount).to.be.undefined();
    expect(uri.otherParam).to.be.undefined();

    uri = URI.parse('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7?amount=123.22');
    uri.address.should.equal('xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7');
  ...
  it('URIs can be validated statically (test vector)', function() {
    URI.isValid('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7').should.equal(true);
    URI.isValid('bitcoin:mkYY5NRvikVBY1EPtaq9fAFgquesdjqECw').should.equal(true);

    URI.isValid('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7?amount=1.2')
                .should.equal(true);
    URI.isValid('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7?amount=1.2&other=param')
                .should.equal(true);
    URI.isValid('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7?amount=1.2&req-other=param',
  ...
  it('do not need new keyword', function() {
    var uri = URI('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7');
  ...
  describe('instantiation from bitcoin uri', function() {
    ...
    it('parses address', function() {
      uri = new URI('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7');
      uri.address.should.be.instanceof(bitcore.Address);
      uri.network.should.equal(Networks.livenet);
    });

    it('parses amount', function() {
      uri = URI.fromString('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7?amount=123.22');
    ...
    it('stores unknown parameters as "extras"', function() {
      uri = new URI('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7?amount=1.2&other=param');
      uri.address.should.be.instanceof(bitcore.Address);
    ...
    it('throws error when a required feature is not supported', function() {
      (function() {
        return new URI('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7?amount=1.2&other=param&req-required=param');
      }).should.throw(Error);
    });
  ...
  it('should support double slash scheme', function() {
    var uri = new URI('bitcoin://xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7');
    uri.address.toString().should.equal('xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7');
  });

  it('should input/output String', function() {
    var str = 'bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7?' +
  ...
  it('should support numeric amounts', function() {
    var uri = new URI('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7?amount=12.10001');
  ...
  it('should generate a valid URI', function() {
    new URI({
      ...
      'bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7'
    );
    ...
    new URI({
      ...
      'bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7?amount=1.10001&message=Hello%20World&something=else'
    );

  });

  it('should be case insensitive to protocol', function() {
    var uri1 = new URI('bItcOin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7');
    var uri2 = new URI('bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7');
  ...
  it('displays nicely on the console (#inspect)', function() {
    var uri = 'bitcoin:xLgj3ZBqCAPajytqEBgtjQYgtaTpaRurk7';
