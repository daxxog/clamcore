...
describe('Script', function() {
  ...
  describe('#buildPublicKeyHashOut', function() {
    it('should create script from livenet address', function() {
      var address = Address.fromString('xVt6PpMgVBncZbWT6HCoo1aVDBChMHTXMc');
      ...
      s.toAddress().toString().should.equal('xVt6PpMgVBncZbWT6HCoo1aVDBChMHTXMc');
    });
  ...
  describe('#buildScriptHashOut', function() {
    ...
    it('inherits network property from other script', function() {
      var s1 = new Script.fromAddress(new Address('xNjzQdZxetT2WkqUJvhhFE4GYJSLTwhthC'));
  ...
  describe('toAddress', function() {
    ...
    it('for a P2PKH address', function() {
      var stringAddress = 'xVt6PpMgVBncZbWT6HCoo1aVDBChMHTXMc';
    ...
    it('works for p2pkh output', function() {
      ...
      script.toAddress().toString().should.equal('xScnhru4Wzce4GCD8CKMim6DTPFGnbWZCV');
    });
    it('works for p2pkh input', function() {
      ...
      s2.toAddress().toString().should.equal('xEnokPvjgwak8jbjxf7EEiEVKV11cFNmxi');
    });
